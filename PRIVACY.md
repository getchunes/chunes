...
published version exists, including an explicitly labeled unsigned manual
release, Chunes opens that version's GitHub release page in the default browser.
The browser then makes its normal requests to GitHub. Chunes does not currently
